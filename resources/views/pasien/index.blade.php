                        ...
                        <div class="direct-chat-messages">
                            ...
                            <div class="direct-chat-msg">
                                <div class="direct-chat-infos clearfix">
                                    <span class="direct-chat-name float-left">Wanda Yuniar</span>
                                    <span class="direct-chat-timestamp float-right">16 Apr 2:00 pm</span>
                                </div>
                                <!-- /.direct-chat-infos -->
                            ...
                            <div class="direct-chat-msg right">
                                <div class="direct-chat-infos clearfix">
                                    <span class="direct-chat-name float-right">Nadia Aulia</span>
                            ...
                            <div class="direct-chat-msg">
                                <div class="direct-chat-infos clearfix">
                                    <span class="direct-chat-name float-left">Wanda Yuniar</span>
                                    <span class="direct-chat-timestamp float-right">16 Ar 5:37 pm</span>
                                </div>
                                <!-- /.direct-chat-infos -->
                                <img class="direct-chat-img" src="{{asset('lte/dist/img/user1-128x128.jpg')}}"
                                    alt="message user image">
                            ...
                            <div class="direct-chat-msg right">
                                <div class="direct-chat-infos clearfix">
                                    <span class="direct-chat-name float-right">Nadia Aulia</span>
                                    <span class="direct-chat-timestamp float-left">16 Apr 6:10 pm</span>
                                </div>
                                <!-- /.direct-chat-infos -->
                                <img class="direct-chat-img" src="{{asset('lte/dist/img/user3-128x128.jpg')}}"
                                    alt="message user image">
